/*
 * Adapted from ThreeUI Community's DotMatrixBackground.
 * Copyright (c) 2026 Meng To. Used under the MIT License.
 */

export const THREEUI_DOT_VERTEX_SHADER = `
  varying vec2 vUv;
...
export const THREEUI_DOT_FRAGMENT_SHADER = `
  uniform float uTime;
  ...
  void main() {
    ...
    float distanceToCenter = length(grid - vec2(0.5));
    ...
    vec3 color = uColor * (0.35 + pulse * 0.65);
